...
import {e , menu , close} from '../assets';
...
const Navbar = () => {
  ...
  return (
   ...
   items-center flex py-5 fixed top-0 z-20 bg-primary`}> 
        ...
        onClick={()=> {
          ...
          > 
          <img src={e} alt="e" className=' w-9 h-9
           object-contain'  />
           <p className='text-[#050505] text-[18px]
           font-bold cursor-pointer flex'>Egemen &nbsp;
            ...
            >
              {navLinks.map((Link) =>( 
                ...
                className={`${
                  ...
                  ? "text-white"
                  : "text-[#121213]"
                } hover:text-white font-medium text-[18px] transition-all duration-400 cursor-pointer`}
